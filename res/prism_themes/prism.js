    ...
    Prism.hooks.add("wrap", function(e) {
      if (("tag-id" == e.type || "property" == e.type && 0 != e.content.indexOf("-") || "rule" == e.type && 0 != e.content.indexOf("@-") || "pseudo-class" == e.type && 0 != e.content.indexOf(":-") || "pseudo-element" == e.type && 0 != e.content.indexOf("::-") || "attr-name" == e.type && 0 != e.content.indexOf("data-")) && -1 === e.content.indexOf("<") && ("css" == e.language || "scss" == e.language || "markup" == e.language)) {
        var t = "https://webplatform.github.io/docs/",
          n = e.content;
        if ("css" == e.language || "scss" == e.language) t += "css/", "property" == e.type ? t += "properties/" : "rule" == e.type ? (t += "atrules/", n = n.substring(1)) : "pseudo-class" == e.type ? (t += "selectors/pseudo-classes/", n = n.substring(1)) : "pseudo-element" == e.type && (t += "selectors/pseudo-elements/", n = n.substring(2));
  ...
  if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
    ...
    if (e) {
      var t = /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)js$/i,
        s = /[\w-]+\.(?:min\.)js$/i;
      if (e.hasAttribute("data-autoloader-path")) a = e.getAttribute("data-autoloader-path").trim().replace(/\/?$/, "/");
      else {
        var i = e.src;
  ...
  function m(e, t, s) {
    ...
    var a = function() {
        ...
        if (a || (a = n[e] = {
            ...
            success: t,
            error: s
          }), !i && Prism.languages[e]) u(e, "success");
...
! function() {
  if ("undefined" == typeof self || self.Prism) {
    ...
    var e, t = Prism.util.currentScript(),
      r = [],
