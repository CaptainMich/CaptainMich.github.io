    ...
    var e = /\blang(?:uage)?-(\w+)\b/i,
      ...
      a = _self.Prism = {
        ...
        highlightElement: function(t, n, r) {
          ...
          l && (i = (l.className.match(e) || [, ""])[1], s = a.languages[i]), t.className = t.className.replace(e, "").replace(/\s+/g, " ") + " language-" + i, l = t.parentNode, /pre/i.test(l.nodeName) && (l.className = l.className.replace(e, "").replace(/\s+/g, " ") + " language-" + i);
          var o = t.textContent,
            u = {
              element: t,
              language: i,
                  ...
                  if (!(y instanceof r)) {
                    ...
                    if (!v && d && h != i.length - 1) {
                      var k = i[h + 1].matchedStr || i[h + 1],
                        w = y + k;
                      if (h < i.length - 2 && (w += i[h + 2].matchedStr || i[h + 2]), c.lastIndex = 0, v = c.exec(w), !v) continue;
                    ...
                    if (v) {
                      ...
                      S.push(N), _ && S.push(_), Array.prototype.splice.apply(i, S)
                    }
                  }
                }
              }
